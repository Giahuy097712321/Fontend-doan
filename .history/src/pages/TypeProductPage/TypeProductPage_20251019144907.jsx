...
const TypeProductPage = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      let res
      if (state) {
        // 🔍 Nếu có danh mục (vd: "Tủ lạnh") thì chỉ lấy loại đó
        res = await ProductService.getProductType(state, paginate.page, paginate.limit)
      } else {
        // 🧩 Nếu không có danh mục thì lấy tất cả
        res = await ProductService.getAllProduct('', paginate.limit)
      }
