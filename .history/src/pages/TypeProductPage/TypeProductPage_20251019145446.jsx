...
const TypeProductPage = () => {
  ...
  // 🧠 Gọi API lấy sản phẩm theo danh mục (nếu có)
  ...
  // ⚡ Gọi lại khi danh mục hoặc trang đổi
  useEffect(() => {
    fetchProducts()
  ...
  // ⚡ Khi chọn danh mục khác trong Select → điều hướng
  useEffect(() => {
    if (selectedType && selectedType !== state) {
      navigate('/type', { state: selectedType })
    }
  }, [selectedType, state, navigate])
