            ...
            <FooterTop>
                <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <SocialIcons style={{ justifyContent: 'center', marginTop: '15px' }}>
                        <SocialIcon href="https://facebook.com/your-profile" target="_blank" color="#1877F2">
                            <FacebookOutlined />
                        </SocialIcon>
                        <SocialIcon href="https://tiktok.com/your-profile" target="_blank" color="#000000">
                            <TikTokOutlined />
                        </SocialIcon>
                        <SocialIcon href="https://youtube.com/your-channel" target="_blank" color="#FF0000">
                            <YoutubeOutlined />
                        </SocialIcon>
                        <SocialIcon href="mailto:your-email@gmail.com" color="#D44638">
                            <MailOutlined />
                        </SocialIcon>
                    </SocialIcons>
                </div>
