    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: '1 1 45%', background: '#fff', padding: 16, borderRadius: 12, boxShadow: '0 4px 8px rgba(0,0,0,0.1)', marginBottom: 16 }}>
                    <h3 style={{ textAlign: 'center', marginBottom: 16 }}>Doanh thu theo trạng thái giao hàng</h3>
                ...
                <div style={{ flex: '1 1 45%', background: '#fff', padding: 16, borderRadius: 12, boxShadow: '0 4px 8px rgba(0,0,0,0.1)', marginBottom: 16 }}>
                    <h3 style={{ textAlign: 'center', marginBottom: 16 }}>Doanh thu theo phương thức thanh toán</h3>
                    <PieChart width={350} height={300}>
                        <Pie
                            dataKey="revenue"
