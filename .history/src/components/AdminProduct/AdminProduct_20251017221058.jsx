...
import { WrapperHeader, WrapperUploadFile, WrapperAddButton, WrapperTable, WrapperModalTitle, WrapperFormItem, WrapperSubmitButton } from './style';
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <WrapperAddButton onClick={() => setIsModalOpen(true)}>
          <PlusOutlined />
        </WrapperAddButton>
      </div>
      ...
      {/* Modal tạo sản phẩm */}
      <ModalComponent title={<WrapperModalTitle>Tạo Sản Phẩm</WrapperModalTitle>} open={isModalOpen} onCancel={handleCancel} footer={null}>
        <Loading isLoading={isLoading}>
          <Form form={formCreate} onFinish={onFinish} autoComplete="off">
            <WrapperFormItem>
              <InputComponent value={stateProduct.name} onChange={handleOnchange} name="name" placeholder="Tên sản phẩm" />
            </WrapperFormItem>
            <WrapperFormItem>
              <Select
            ...
            <WrapperFormItem>
              ...
              >
                ...
                {stateProduct?.image && <img src={stateProduct.image} alt="avatar" />}
              </WrapperUploadFile>
            </WrapperFormItem>
            <WrapperSubmitButton htmlType="submit">Tạo sản phẩm</WrapperSubmitButton>
          </Form>
        </Loading>
      </ModalComponent>
    </div>
