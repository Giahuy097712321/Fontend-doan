...
const AdminOrder = () => {
    ...
    const deliveredOrders = useMemo(() => orders?.data?.filter(o => o.isDelivered).length || 0, [orders]);
    const pendingOrders = useMemo(() => orders?.data?.filter(o => !o.isDelivered).length || 0, [orders]);
    const totalOrders = useMemo(() => orders?.data?.length || 0, [orders]);
        ...
        <div>
            ...
            <InfoCardContainer>
                ...
                <InfoCard>
                    ...
                    <InfoNumber>{totalOrders}</InfoNumber>
                </InfoCard>
                <InfoCard>
                    <InfoLabel>Đã giao</InfoLabel>
                    <InfoNumber>{deliveredOrders}</InfoNumber>
                </InfoCard>
                <InfoCard>
                    <InfoLabel>Chưa giao</InfoLabel>
                    <InfoNumber>{pendingOrders}</InfoNumber>
                </InfoCard>
            </InfoCardContainer>
